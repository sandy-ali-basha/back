...
class ProductAttributesController extends Controller
{
   ...
   public productAttributesService $productAttributesService;
    ...
    public function toggleStatus($id)
    {
        ...
        // Toggle status as boolean true/false
    ...
    public function toggleNavStatus($id)
    {
        $category = ProductAttributes::find($id);
        ...
        // Toggle nav_active between 0 and 1
        $category->nav_active = $category->nav_active ? 0 : 1;
        $category->save();

        return response()->success(new SuccessResponse([
            'id' => $category->id,
            'navActive' => (int) $category->nav_active,
        ], 200, 'updated successfully'));
    }
