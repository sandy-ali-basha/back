...
use App\Services\CreateCustomOrder;
...
return [
    ...
    */
    'actions' => [
        ...
        'order_create' => CreateCustomOrder::class,
    ],
    ...
    */
    'validators' => [
        ...
        'order_create' => [
            \App\Http\Helpers\ValidateCartForOrderCreation::class,
        ],
    ],
