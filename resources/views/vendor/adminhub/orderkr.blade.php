...
?>
      <div class="invoice-header">
        <div>
          <h1 class="title" style="font-size: 20px">فاتورة / بیکەرەوە</h1>
          <span class="title"> تاريخ الطلب / ڕۆزى داواكردن:&nbsp;</span
          ><span dir="ltr"
            >{{
            \Carbon\Carbon::createFromTimeString($order->created_at)->format('d-m-Y
            h:m A') }}</span
          ><br />
          <span class="title">رقم الفاتورة / زمارەی پسوولە :&nbsp;</span
          ><span dir="ltr">{{ @$order->reference }}</span><br />
          <span class="title">رقم الطلب / ژمارەی داواكردن :&nbsp;</span
          ><span dir="ltr">{{ @$order->id }}</span><br />
          <span class="title">طريقة الدفع / شێوازی پارەدان :&nbsp;</span
          ><span dir="ltr"
        ...
        <div>
          <span class="title">اسم الزبون / كریار: &nbsp;</span
          ><span dir="ltr"
            ><?php echo e(
    $customer
        ...
        : 'Admin'
          ...
          ><br />
          <span class="title">رقم الهاتف / تەلەفۆن: &nbsp;</span
          ><span dir="ltr"
            ><?php echo e($customer->phone_number ?? '—'); ?></span
          ><br />
          <span class="title">المدينة / شار : &nbsp;</span
          ><span dir="ltr">{{ $order->addresses()->first()->city }}</span><br />
          <span class="title">العنوان / ناونیشان : &nbsp;</span
          ><span dir="ltr">
          ...
          <br />
          <span class="title">البريد الالكتروني / ئیمەیڵ :&nbsp;</span
          ><span dir="ltr"><?php echo e($order->user->email ?? $customer->email ?? '—'); ?></span><br />
        </div>
      </div>
      <h4 style="text-align: center;font-size: 18px" class="title">
        تفاصيل الطلب / زانیاری داواکاری
      </h4>
      <br />
      <table class="table">
        <thead>
          <tr>
            <th class="title header">الاجمالي / گشتی</th>
            <th class="title header">السعر / نرخ</th>

            <th class="title header">المنتجات / بەرهەمەکان</th>
            <th class="title header">الكميّة / بڕ</th>
          </tr>
        </thead>
        <tbody>
      ...
      <div class="summary" style="padding-top: 20%">
        <table>
          <tr>
            <td class="title">الإجمالي / گشتی :</td>
            <td>
              {{
          ...
          <tr>
            <td class="title">الشحن والتوصيل / گەیاندن :</td>
            <td>
              {{
          ...
          <tr>
            <td class="title">رمز الكوبون / کۆدی کۆبۆن :</td>
            <td>{{ $discount->name }}</td>
          </tr>

          <tr>
            <td class="title">حسم الكوبون % / داشکاندنی کۆبۆن % :</td>
            <td>
          ...
          @else
          <tr>
            <td class="title">لا يوجد كوبون / هیچ کۆبۆنێک نییە</td>
            <td>—</td>
          </tr>
          @endif

          <tr>
            <td class="title">النقاط المخصومة / خاڵەكانی داشكاندن :</td>
            <td>{{$order->points_used}}</td>
          </tr>
          <tr>
            <td class="title">
              قيمة النقاط المخصومة / بەهای خاڵەكانی داشكاندن :
            </td>
            <td>
          ...
          <tr class="total">
            <td class="title">المجموع الإجمالي / کۆی گشتی :</td>
            <td>
      ...
      <div class="note">
        <strong>تعليمات التسليم / ڕێنماییەکانی گەیاندن: </strong> {{
      ...
      <div class="note">
        <strong>توقيع المستلم / واژۆ: </strong> __________________
      </div>
      <div class="note">
        <strong>تاريخ التسليم / بەرواری گەیاندن: </strong> __________________
      </div>
    </div>
  </body>
</html>
